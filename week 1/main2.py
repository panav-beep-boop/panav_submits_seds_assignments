...
#its better to make the velocity stop before correct the position by 
# offset because if you correct offset first, the ball keeps going on in that execution time
